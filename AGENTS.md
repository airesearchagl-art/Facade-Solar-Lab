...
1. Read `docs/VALIDATION_PLAN.md` for the current M5 P0-A hourly EPW contract and prioritized validation backlog.
...
- Current milestone: M5 — Validation / Stability; current scope is P0-A hourly EPW temporal integrity. Detailed sub-hour, polar, and third-party solver validation remain planned.
