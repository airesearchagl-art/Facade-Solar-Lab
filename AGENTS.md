...
1. Read `docs/VALIDATION_PLAN.md` for the current M5 P0-B independent direct-shadow protocol and prioritized validation backlog.
...
- Current milestone: M5 — Validation / Stability; P0-A focused review passed. P0-B direct-shadow protocol/fixture is prepared; actual Radiance comparison is NOT RUN. Do not count skipped external benchmarks or test doubles as solver PASS. Detailed sub-hour, polar, annual physical validation, and M6 remain planned.
