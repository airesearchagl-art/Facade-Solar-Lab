...
export const AXES: readonly { key: AxisKey; label: string; unit: string }[] = [
  { key: "overhang.depthM", label: "庇の出", unit: "m" },
  { key: "overhang.elevationZM", label: "庇高さ", unit: "m" },
  { key: "overhang.leftExtensionM", label: "庇・左側延長", unit: "m" },
  { key: "overhang.rightExtensionM", label: "庇・右側延長", unit: "m" },
  { key: "intermediateFins.depthM", label: "中間フィンの出", unit: "m" },
  { key: "intermediateFins.layout.pitchM", label: "中間フィン中心ピッチ", unit: "m" },
  { key: "intermediateFins.layout.count", label: "中間フィン枚数", unit: "枚" },
  { key: "leftFin.depthM", label: "左端部フィンの出", unit: "m" },
  { key: "rightFin.depthM", label: "右端部フィンの出", unit: "m" },
  { key: "opening.widthM", label: "開口幅", unit: "m" },
  { key: "opening.sillZM", label: "開口下端", unit: "m" },
  { key: "opening.headZM", label: "開口上端", unit: "m" },
  { key: "facadeAzimuthDegFromNorth", label: "方位角（北0・時計回り）", unit: "°" },
  { key: "solarHeatGainCoefficient", label: "SHGC", unit: "—" },
  { key: "groundReflectance", label: "地面反射率", unit: "—" },
];
export const axisLabel = (key: AxisKey) => AXES.find(axis => axis.key === key)!.label;
