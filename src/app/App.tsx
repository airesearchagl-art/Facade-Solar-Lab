  ...
  return (
    <main className="shell">
      <section className="hero" aria-labelledby="product-title">
        <p className="eyebrow">M1 · ENGINE BASELINE</p>
      ...
      <section className="foundation" aria-label="M1 foundation">
      ...
      <p className="scope-note">
        Legacy calculation baseline available. Absolute values are not a validated
