...
| D-010 | Close M0 after PR #1 squash merge | Human reported the completed Independent Review and merge; fresh `origin/main` is `b633a2b...` | M0 is terminal; M1 uses an independent run directory and branch |
