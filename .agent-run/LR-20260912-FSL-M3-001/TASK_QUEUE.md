...
| ---: | --- | --- | --- | --- |
| 1 | Wave 0 | Fresh preflight, M2 closeout, M3 artifacts | ACTIVE | Exact base, baseline regressions, immutable snapshot |
| 2 | Wave 1 | Geometry contract and validation | PENDING | Opening/overhang/datum/azimuth tests |
| 3 | Wave 2 | Polygon primitives and epsilon | PENDING | P1–P6 focused tests |
